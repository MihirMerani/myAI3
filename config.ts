...
export const AI_NAME = "ML Check";
export const OWNER_NAME = "Mihir & Lakshay";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, your AI legal assistant. Upload a document or ask a legal question — I'll help you understand it in plain English, Hindi, Marathi, or Gujarati.`;

export const SUPPORTED_LANGUAGES = ["English", "Hindi", "Marathi", "Gujarati"] as const;

export const BHASHINI_API_BASE = "https://dhruva-api.bhashini.gov.in/services/inference/pipeline";
